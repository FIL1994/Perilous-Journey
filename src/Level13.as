package 
{
	...
	public class Level13 extends World
	{
		...
		{			
			...
			add(new EnemyBoss3(FP.screen.width / 5 + 10, 15, Colours.TOMATO, 48));
			MyGame.enemyCount = 1;
