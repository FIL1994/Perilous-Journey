package enemies 
{
	 ...
	 * @author Philip VR
	 */
	public class EnemySquare extends Entity 
	{
		private const death:Sfx = new Sfx(Sounds.ENEMY_DEATH_2);
		
		[Embed(source="../../assets/enemies/enemySquare.png")] private const ENEMY_SQUARE_GRAPHIC:Class;
		...
		public function EnemySquare(x:Number = 0, y:Number = 0) 
		{
			...
			type = "enemy";
			shootOnFrame = MyGame.randRange(80, 115);
		...
		override public function update():void 
		{
			...
			if (shoot) {
				MyGame.shotsAgainst++;
				world.add(new EnemyBullet(x + 5, y + 6, 25, 3, Colours.RUST));
				shoot = false;
			}
		}
