package enemies 
{
	 ...
	 * @author Philip VR
	 */
	public class EnemyBoss4 extends Entity 
	{
		...
		[Embed(source="../../assets/enemies/boss4.png")] private const ENEMY_BOSS_GRAPHIC:Class;
		...
		public function EnemyBoss4(posX:Number = 0, posY:Number = 0, myColour:uint = Colours.ORANGE_RED, startHealth:Number = 10) 
		{
			colour = myColour;
			health = startHealth;
		...
		override public function update():void 
		{
			...
			if (shoot) {
				MyGame.shotsAgainst++;
				world.add(new EnemyExplosiveBullet(x + 25, y + 46, 38, 5));
				shoot = false;
			}
