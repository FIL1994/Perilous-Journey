package enemies 
{
	 ...
	 * @author Philip VR
	 */
	public class EnemyBoss6 extends Entity 
	{
		private var dx:Number = 0.001;
		private var dy:Number = 0.001;
		
		private const hitSound:Sfx = new Sfx(Sounds.BOSS_HIT_9);
		
		[Embed(source="../../assets/enemies/boss6.png")] private const ENEMY_BOSS_GRAPHIC:Class;
		...
		public function EnemyBoss6(posX:Number = 0, posY:Number = 0, myColour:uint = Colours.ORANGE_RED, startHealth:Number = 10) 
		{
			colour = myColour;
			health = startHealth;
		...
		override public function update():void 
		{
			...
			if (shoot) {
				//MyGame.shotsAgainst++;
				world.add(new EnemySquare(x + 15, y + 55));
				world.add(new EnemySquare(x + 40, y + 55));
				shoot = false;
			}
