package enemies 
{
	 ...
	 * @author Philip VR
	 */
	public class EnemyBoss7 extends Entity 
	{
		private var dx:Number = 0.001;
		private var dy:Number = 0.001;
		
		private const hitSound:Sfx = new Sfx(Sounds.BOSS_HIT_4);
		
		[Embed(source="../../assets/enemies/boss7.png")] private const ENEMY_BOSS_GRAPHIC:Class;
		...
		public function EnemyBoss7(posX:Number = 0, posY:Number = 0, myColour:uint = Colours.ORANGE_RED, startHealth:Number = 10) 
		{
			colour = myColour;
			health = startHealth;
