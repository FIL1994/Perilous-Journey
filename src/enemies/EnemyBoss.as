package enemies 
{
	...
	public class EnemyBoss extends Entity 
	{
		...
		private const hitSound:Sfx = new Sfx(Sounds.BOSS_HIT);
		
		[Embed(source="../../assets/enemies/enemyBoss.png")] private const ENEMY_BOSS_GRAPHIC:Class;
		...
		public function EnemyBoss(posX:Number = 0, posY:Number = 0, myColour:uint = Colours.ORANGE_RED, startHealth:Number = 10) 
		{
			colour = myColour;
			health = startHealth;
		...
		override public function update():void 
		{
			...
			if (shoot) {
				MyGame.shotsAgainst++;
				world.add(new EnemyBullet(x + 25, y + 46, 35, 5));
				shoot = false;
			}
		...
		private function updateCollision():void {
			if (collide("playerBullet", x, y) && health > 0) {
				hitSound.play();
				health--;
				hurt = true;
			}
