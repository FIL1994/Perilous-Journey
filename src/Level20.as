package 
{
	...
	public class Level20 extends World
	{
		...
		{			
			...
			add(new EnemyBoss4(FP.screen.width / 5 + 10, 15, Colours.MAGENTA, 60));
			MyGame.bossCount = 1;
