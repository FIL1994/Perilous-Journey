package 
{
	...
	public class Level18 extends World
	{
		...
		{			
			...
			add(new EnemyTwoShots(200, 30, MyGame.randomColour()));			
			add(new EnemyTwoShots(90, 50, MyGame.randomColour()));
			
			add(new EnemyTwoShots(135, 50, MyGame.randomColour()));
			add(new EnemyTwoShots(90, 30, MyGame.randomColour()));
			...
			add(new EnemyTwoShots(135, 60, MyGame.randomColour()));
			add(new EnemyTwoShots(90, 40, MyGame.randomColour()));
			add(new EnemyTwoShots(135, 40, MyGame.randomColour()));
			add(new EnemyTwoShots(180, 40, MyGame.randomColour()));
			add(new EnemyTwoShots(180, 60, MyGame.randomColour()));
			
			add(new EnemyTwoShots(70, 60, MyGame.randomColour()));
			add(new EnemyTwoShots(200, 60, MyGame.randomColour()));
			add(new EnemyTwoShots(70, 40, MyGame.randomColour()));
			add(new EnemyTwoShots(200, 40, MyGame.randomColour()));			
			add(new EnemyTwoShots(90, 60, MyGame.randomColour()));
		...
		private function nextLevel():void {	
			...
			trace("18-Seconds: " + levelSeconds);
			FP.world.removeAll();
			levelText.visible = false;
			FP.world = new Level19();
		}
