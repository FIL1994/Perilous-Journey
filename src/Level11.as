package 
{
	...
	public class Level11 extends World
	{
		...
		{			
			...
			add(new EnemySquare(175, 60));
			add(new EnemySquare(175, 40));
			
			MyGame.enemyCount = 18;
			
			add(new BulletsPowerup(205, 105));
