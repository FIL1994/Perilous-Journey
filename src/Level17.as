package 
{
	...
	public class Level17 extends World
	{
		...
		{			
			...
			add(new EnemySquare(200, 70));
			add(new EnemySquare(65, 70));
			add(new EnemySquare(180, 70));
			add(new EnemySquare(85, 70));
			add(new EnemySquare(160, 70));
			add(new EnemySquare(105, 70));
			
			MyGame.enemyCount = 26;			
			
			levelText.defaultTextFormat = new TextFormat("Iceland", 22);
			levelText.embedFonts = true;
			levelText.textColor = Colours.CRIMSON;
			levelText.text = "Level 17";					
			levelText.x = 8;
		...
		private function nextLevel():void {	
			...
			trace("17-Seconds: " + levelSeconds);
			FP.world.removeAll();
			levelText.visible = false;
			FP.world = new Level18();
		}
