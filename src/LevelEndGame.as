package 
{
	 ...
	 * @author Philip VR
	 */
	public class LevelEndGame extends World
	{
		...
		private var playAgain:PushButton = new PushButton(null, 250, 210, "Play Again", myFunction);
		...
		public function LevelEndGame() 
		{
			stage = FP.stage;
			FP.screen.color = Colours.PINEAPPLE;
			MyGame.currLevel = "LevelEndGame";
			MyGame.score = 0;
		}
		...
		override public function begin():void 
		{
			...
			tweener.tween(0, MyGame.totalScore, 205);
