package 
{
	 ...
	 * @author Philip VR
	 */
	public class Level19 extends World
	{
		...
		{			
			...
			add(new EnemySide(175, 50));
			add(new EnemySide(105, 50));
			add(new EnemySide(155, 50));
			add(new EnemySide(85, 50));
			add(new EnemySide(195, 50));
			add(new EnemySide(125, 50));
			
			add(new EnemySquare(70, 60));
			add(new EnemySquare(170, 60));
			add(new EnemySquare(90, 60));
			add(new EnemySquare(110, 60));
			add(new EnemySquare(150, 60));
			
			add(new EnemySquare(190, 60));
			add(new EnemySquare(210, 60));				
			
			MyGame.enemyCount = 23;	
			
			levelText.defaultTextFormat = new TextFormat("Iceland", 22);
			levelText.embedFonts = true;
			levelText.textColor = Colours.CRIMSON;
			levelText.text = "Level 19";					
			levelText.x = 8;
		...
		private function nextLevel():void {	
			...
			trace("19-Seconds: " + levelSeconds);
			FP.world.removeAll();
			levelText.visible = false;
			FP.world = new Level20();
		}
