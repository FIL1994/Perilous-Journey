package 
{
	...
	public class Level5 extends World
	{
		...
		private var beatTime:int = 14;
		
		public function Level5() 
		{
			stage = FP.stage;
			FP.screen.color = Colours.LIGHT_STEEL_BLUE;
			MyGame.currLevel = "Level5";
			MyGame.score = 0;
		}
		...
		{			
			...
			add(new Enemy(FP.screen.width / 3, 30, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 3, 30, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 2, 30, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 2, 30, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 2, 30, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 2, 30, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 2, 30, MyGame.randomEnemyColour(), true));
			
			add(new Enemy(FP.screen.width - 95, 50, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 3, 50, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 3, 50, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width - 95, 50, MyGame.randomEnemyColour(), true));
			add(new Enemy(FP.screen.width / 3, 50, MyGame.randomEnemyColour(), true));

			MyGame.enemyCount = 15;
